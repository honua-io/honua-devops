...
// Shared BackendConfiguration for tests that only need a reachable, well-formed set of
// endpoint paths. Individual suites keep their own factory when they assert on specific
// paths; this exists so new suites do not have to restate 20 defaults.
internal static class BackendConfigurationFixture
{
    internal static BackendConfiguration Create()
        => new(
